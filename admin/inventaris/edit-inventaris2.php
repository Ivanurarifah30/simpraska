	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input date="date" class="form-control" id="tgl_pengecekan" name="tgl_pengecekan" value="<?php echo $data_cek['tgl_pengecekan']; ?>"
					/>
				</div>
			</div>
...
if (isset ($_POST['Ubah'])){
    ...
    if ($query_ubah) {
        ...
        Swal.fire({title: 'Ubah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
            ...
            if (result.value) {
                window.location = 'dashboard.php?page=inventaris2';
            }
        })</script>";
        }else{
        echo "<script>
