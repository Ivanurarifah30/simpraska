            ...
            <div class="card-body p-0">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 150px"><b>Tgl Pelaksana</b></td>
                            <td>: <?php echo htmlspecialchars($data_cek['tgl_pelaksana']); ?></td>
                        </tr>
                        <tr>
                ...
                <div class="card-footer">
                    <a href="?page=data-proker2" class="btn btn-warning">Kembali</a>
                    </div>
            </div>
        </div>
    </div>
        ...
        <div class="card card-success">
            ...
            <div class="card-body">
                ...
                <h3 class="profile-username text-center">
                    <?php echo htmlspecialchars($data_cek['nama_proker']); ?> - <?php echo htmlspecialchars($data_cek['tgl_pelaksana']); ?>
                </h3>
            </div>
        </div>
    </div>
