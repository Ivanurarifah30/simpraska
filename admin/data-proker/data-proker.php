    ...
    <div class="card-body">
        <div class="table-responsive">
            ...
            <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link <?php if ($status_filter == 'Direncanakan') echo 'active'; ?>" id="Direncanakan-tab" href="?page=data-proker&status=Direncanakan" role="tab" aria-controls="Direncanakan" aria-selected="<?php echo ($status_filter == 'Direncanakan') ? 'true' : 'false'; ?>">
                        <i class="fa fa-calendar"></i> Proker Direncanakan
                    </a>
                </li>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link <?php if ($status_filter == 'Berlangsung') echo 'active'; ?>" id="Berlangsung-tab" href="?page=data-proker&status=Berlangsung" role="tab" aria-controls="Berlangsung" aria-selected="<?php echo ($status_filter == 'Berlangsung') ? 'true' : 'false'; ?>">
                        <i class="fa fa-spinner fa-spin"></i> Proker Berlangsung
                    </a>
                </li>

                <li class="nav-item" role="presentation">
                    <a class="nav-link <?php if ($status_filter == 'Selesai') echo 'active'; ?>" id="Selesai-tab" href="?page=data-proker&status=Selesai" role="tab" aria-controls="Selesai" aria-selected="<?php echo ($status_filter == 'Selesai') ? 'true' : 'false'; ?>">
                ...
                <tbody>
                    ...
                    while ($data = $sql->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="?page=view-proker&kode=<?php echo htmlspecialchars($data['id_proker']); ?>" title="Detail" class="btn btn-info btn-sm">
                                    <i class="fa fa-eye"></i>
                                </a>
                                <a href="?page=edit-proker&kode=<?php echo htmlspecialchars($data['id_proker']); ?>" title="Ubah" class="btn btn-success btn-sm">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="?page=del-proker&kode=<?php echo htmlspecialchars($data['id_proker']); ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
