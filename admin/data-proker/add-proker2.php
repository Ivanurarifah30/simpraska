<div class="card card-primary">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Tgl Pelaksana</label>
                <div class="col-sm-5">
                    <input type="date" class="form-control" id="tgl_pelaksana" name="tgl_pelaksana" placeholder="tgl_pelaksana" required>
                </div>
            </div>
        ...
        <div class="card-footer">
            ...
            <a href="?page=data-proker2" title="Kembali" class="btn btn-secondary">Batal</a>
        </div>
    </form>
</div>
...
if (isset($_POST['Simpan'])) {
    ...
    if ($pindah) {
        $sql_simpan = "INSERT INTO tb_proker (id_proker, nama_proker, tgl_pelaksana, status, id_pj, keterangan, upload_rab) VALUES (
            '" . mysqli_real_escape_string($koneksi, $_POST['id_proker']) . "',
            '" . mysqli_real_escape_string($koneksi, $_POST['nama_proker']) . "',
            '" . mysqli_real_escape_string($koneksi, $_POST['tgl_pelaksana']) . "',
        ...
        if ($query_simpan) {
            ...
            echo "<script>
                Swal.fire({
                    ...
                    if (result.value) {
                        window.location = 'dashboard.php?page=add-proker2';
                    }
                })
            </script>";
        }
